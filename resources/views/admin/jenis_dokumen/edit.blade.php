		...
		<div class="card">
			...
			<div class="card-body p-3 text-center">
				<?php if($jenis_dokumen->gambar != "") { ?>
		            <img src="{{ asset('assets/upload/image/thumbs/'.$jenis_dokumen->gambar) }}" class="img img-fluid img-thumbnail">
		...
		<div class="card">
			...
			<div class="card-body p-3">
				...
				<div class="form-group row mb-3">
					...
					<div class="col-sm-4">
						<input type="text" name="kode_jenis_dokumen" class="form-control" placeholder="Kode Jenis Dokumen" value="{{ $jenis_dokumen->kode_jenis_dokumen }}" required>
						<small class="text-secondary">Kode Jenis Dokumen</small>
					</div>
					<div class="col-sm-5">
						<input type="number" name="urutan" class="form-control" placeholder="Nomor Urut Jenis Dokumen" value="{{ $jenis_dokumen->urutan }}" required>
