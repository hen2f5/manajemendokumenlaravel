	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="{{ asset('admin/perkembangan/tambah') }}" enctype="multipart/form-data" method="post" accept-charset="utf-8">
{{ csrf_field() }}

				<div class="form-group row mb-3">
					<label class="col-sm-3 control-label text-right">Status Jenis Perkembangan</label>
					<div class="col-sm-9">
				...
				<div class="form-group row mb-3">
					...
					<div class="col-sm-9">
						<input type="text" name="nama_perkembangan" class="form-control" placeholder="Nama lengkap" value="{{ old('nama_perkembangan') }}" required>
					</div>
				</div>
				...
				<div class="form-group row mb-3">
					...
					<div class="col-sm-4">
						<input type="text" name="kode_perkembangan" class="form-control" placeholder="Kode Perkembangan" value="{{ $kode_perkembangan }}" required>
						<small class="text-secondary">Kode Jenis Dokumen</small>
					</div>
					<div class="col-sm-5">
						<input type="number" name="urutan" class="form-control" placeholder="Nomor Urut Perkembangan" value="{{ $kode }}" required>
